...
# Creates a window to take input from webcam
# note that the image taken as input should be 28x28 grayscale image,
# because the model is trained on 28x28 size image
...
def keras_predict(model, image):
    ...
    # softmax function to choose the max probability alphabet
